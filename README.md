...
C3P0 is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running C3P0 Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start C3P0 locally by running:
...
Then you can interact with C3P0 by typing `C3P0 help`.

    C3P0> C3P0 help
    C3P0 animate me <query> - The same thing as `image me`, except adds [snip]
    C3P0 help - Displays all of the help commands that C3P0 knows about.
    ...
